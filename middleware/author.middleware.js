...
module.exports = async function (req,res,next) {
    try {
        ...
        if(post.author.toString() !== authorId){//post create qilishda qilgan odamni datalarini ushlab qolganmiz shu bilan hozirgi userni access tokenidan yana userini chiqarish
